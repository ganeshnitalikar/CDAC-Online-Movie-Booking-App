...
import {
  ...
  Stack, Button, Chip, Skeleton, TextField, InputAdornment,
  Select, FormControl, InputLabel, MenuItem, Dialog,
  DialogTitle, DialogContent, DialogActions, Divider, Avatar
} from "@mui/material";
import {
  Search as SearchIcon,
  Movie as MovieIcon,
        ...
        <Stack spacing={2}>
          <Stack direction="row" justifyContent="space-between">
            <Stack direction="row" spacing={2}>
              ...
              <Box>
                <Typography variant="h6" fontWeight={700}>{booking.movieTitle}</Typography>
                <Typography variant="body2" color="text.secondary">
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={6} sm={3}>
              ...
              <Typography fontWeight={600}>{booking.seats.join(", ")}</Typography>
            </Grid>
            <Grid item xs={6} sm={3}>
              <Typography variant="caption">Amount</Typography>
              <Typography fontWeight={700} color="primary.main">₹{booking.total}</Typography>
            </Grid>
            <Grid item xs={6} sm={3}>
  ...
  const fetchBookings = async () => {
    ...
    try {
      ...
      const mapped = data.map(b => ({
        ...
        movieTitle: `Movie ${b.movieId.slice(-4)}`,
        theater: `${b.theatreName} • ${b.screenName}`,
        showTime: b.showStartTime,
        seats: b.seats,
        total: b.amountPaid / 100,
      ...
      <Container maxWidth="lg">
        ...
        <Dialog open={cancelDialog} onClose={() => setCancelDialog(false)}>
          ...
          <DialogActions>
            ...
            <Button onClick={confirmCancel} color="error" variant="contained">Yes</Button>
          </DialogActions>
        </Dialog>
